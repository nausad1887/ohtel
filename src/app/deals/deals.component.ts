...
export class DealsComponent implements OnInit, OnDestroy, DoCheck {
  public categorytypeID = '7';
  public subCategoryId = '72';
  public locationID = '';
  ...
  ngOnInit(): void {
    this.data.categoryID = this.activatedRoute.snapshot.paramMap.get('dealsID');
    this.updatedCity();
  ...
  public asyncFunctionCall = async () => {
    ...
    this.subCategoryTypeLists$ = this.homeService.dealsSubCategoryTypeList(this.data);
    this.subCATEGORYLists$ = this.homeService.dealsSubCategoryList(this.data);
    this.locationLists$ = this.homeService.getLocationLists(this.cityID);
    this.viewPostMethod();
  }
